...
import org.xtext.example.uno.generator.GameGenerator;
import org.xtext.example.uno.parser.antlr.GameAntlrTokenFileProvider;
import org.xtext.example.uno.parser.antlr.GameParser;
import org.xtext.example.uno.parser.antlr.internal.InternalGameLexer;
import org.xtext.example.uno.scoping.GameScopeProvider;
import org.xtext.example.uno.serializer.GameSemanticSequencer;
import org.xtext.example.uno.serializer.GameSyntacticSequencer;
import org.xtext.example.uno.services.GameGrammarAccess;
import org.xtext.example.uno.validation.GameConfigurableIssueCodesProvider;
import org.xtext.example.uno.validation.GameValidator;
...
public abstract class AbstractGameRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/example/uno/Game.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.example.uno.Game");
	}
